/*
THIS CODE FOR A CHAKRA UI SELECT WAS WRITTEN BY GITHUB USER CSANDMAN
AND IS TAKEN FROM https://gist.github.com/csandman/c687a9fb4275112f281ab9a5701457e4
...
const ChakraReactSelect = ({
  ...
  styles.menu = (provided) => {
    provided.background = "rgba(255, 255, 255, 0)";
    return provided;
  };

  styles.singleValue = (provided) => {
    provided.color = textColor;
    return provided;
  };
